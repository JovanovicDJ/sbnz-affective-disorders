...
public class AffectiveDisordersTests {
    ...
    public void DepressionEpisodeTest() {
        ...
        Symptom symptom1 = new Symptom("low affect", 5, SymptomGroup.DEPRESSIVE_EPISODE, 0);
        ...
        Symptom symptom4 = new Symptom("low concentration", 3, SymptomGroup.DEPRESSIVE_EPISODE, 0);
